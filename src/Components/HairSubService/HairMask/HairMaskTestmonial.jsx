  ...
  return (
    <div className="hairSubServiceCustomer">
      ...
      <p>
        ...
        <a href="https://scentlifestyle.com/">SCENT</a> for their hair care
        needs because of our commitment to quality and customer satisfaction.
      ...
      <div className="hairSubServiceCustomerContent">
        ...
        <p>
          ...
          completely transformed my dry hair! It’s so soft and manageable now.
          <span className="quote">”</span> - <span>Anjali </span>
        </p>
        <p>
...
export default HairMaskTestmonial;
