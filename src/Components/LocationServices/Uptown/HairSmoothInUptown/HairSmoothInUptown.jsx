...
import HairSmoothInUptownHead from './HairSmoothInUptownHead';
import HairSmoothInUptownFooter from './HairSmoothInUptownFooter';
const HairSmoothInUptown = () => {
  return (
    <div>
    <Helmet>
      <meta charSet="utf-8" />
    ...
    <InnerNavi
      link="/hair-salon"
      service="Hair Salon"
      currService="Hair Smoothening in Uptown"
    />
    <HairSmoothInUptownHead />
    <Members />
    <OurSalon />
    <Partners />
    <InstaFeed />
    ...
    <TextLocReviews />
    <ServiceWhy />
    <HairSmoothInUptownFooter />
  </div>
  )
}

export default HairSmoothInUptown
