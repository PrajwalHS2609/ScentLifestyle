...
const HairBotoxInLavelleWhy = () => {
  return (
    <div className="hairSalonInSahakaraWhy">
    <h5>
    Why SCENT is the Best Choice for Hair Botox Treatment in Lavelle Road?    </h5>
    <p>
    At SCENT, we pride ourselves on offering the best Hair Botox Treatment in Lavelle Road with the following benefits:
    </p>
    <ul>
      <li>
        <span>
...
export default HairBotoxInLavelleWhy
