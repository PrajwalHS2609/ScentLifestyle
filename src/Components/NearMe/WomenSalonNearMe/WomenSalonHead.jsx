...
const WomenSalonHead = () => {
  return (
    <div className="nearHeadContainer">
      ...
      <p>
        When you search for a "women's salon near me," you are looking for more
        than just a place to get your hair cut or nails done; you're seeking a
        haven where beauty, comfort, and expertise come together. SCENT Salon is
        ...
        search for a "women's salon near me."
      </p>
    </div>
  );
};
