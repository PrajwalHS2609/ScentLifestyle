...
const FootMassageHead = () => {
  return (
    <div className="nearHeadContainer">
      <h2>Foot Massage Near Me: Relax and Rejuvenate at SCENT  </h2>
      <p>
        ...
        further than <Link to={"/"}>SCENT </Link>. Situated conveniently
        and renowned for its exceptional spa services,
        <Link to="/spa">
          SCENT  offers a variety of foot massage treatments ,
         </Link>
