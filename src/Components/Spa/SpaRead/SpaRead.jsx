      ...
      <div ref={switchRef} className="spaReadDisplayContainer">
        <ul>
          ...
          <li>
            <h4>Deep Tissue Massage</h4>
            <p>
              Tailored for athletes and active individuals, our sportz massages
              enhance recovery, prevent injuries, and optimize athletic
              performance.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Our signature massage is a blend of techniques customized to your
              preferences, ensuring a personalized and deeply relaxing
              experience.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              massages promote relaxation, alleviate muscle tension, and enhance
              overall well-being.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              ...
              <a href="https://scentlifestyle.com/spa">luxurious body scrubs</a>
            ...
            <p>
              At SCENT, we prioritize creating a serene and calming environment
              where you can unwind and escape from the stresses of everyday
              life. Our team of highly trained therapists ensures each session
              is tailored to your specific needs, using only the finest natural
              essential oils and premium skincare products.
            </p>
            <p>
            ...
            <p>
              ...
              and discover why we are renowned for being the best spa near you.
              Remember, when life gets hectic, it's essential to take time for
              yourself and indulge in the rejuvenating benefits of spa therapy.
              Treat yourself to the ultimate relaxation experience at SCENT
              Salon in Bangalore.
            </p>
          </li>
        </ul>
