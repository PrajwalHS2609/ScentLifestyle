  ...
  return (
    <div className="headSpaHeadContainer">
      ...
      <p>
        ...
        scents, and calming ambiance set the stage for a truly indulgent
        experience.
      </p>
      <p>
        ...
        <a href="https://scentlifestyle.com/body-polish-in-bangalore">body polish treatment at SCENT</a> that's perfect for you.
      </p>
    </div>
  );
};

export default BodyPolishSpaXp;
