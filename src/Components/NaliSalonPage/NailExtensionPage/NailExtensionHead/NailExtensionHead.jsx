  ...
  return (
    <div className="nailExtensionHead">
      <div className="nailExtensionHeading">
        <h1>Nail Extension in Bangalore: Experience the Best at SCENT Salon</h1>
        <p>
          If you're seeking <a href="/">premium nail extension in Bangalore,</a>{" "}
          look no further than SCENT Salon. We pride ourselves on offering
          top-notch nail services that combine creativity, precision, and
          high-quality products. Whether you desire a subtle enhancement or a
          dramatic transformation, our skilled technicians are here to cater to
          your needs and give your nails the ultimate makeover.
        </p>
      </div>
      <div className="nailExtensionHeading">
        ...
        <p>
          ...
          unique benefits. At <a href="/">SCENT Salon</a>, our experts will help
          you choose the best type of{" "}
          <a href="/">nail extension in Bangalore</a> to suit your style and
          preferences.
        </p>
      </div>
      <div className="nailExtensionHeading">
        ...
        <p>
          ...
          providing a protective layer that helps them grow healthier. With nail
          extension in Bangalore at SCENT Salon, you can enjoy stunning, durable
          nails that look natural and elegant.
        </p>
      </div>
      <div className="nailExtensionHeading">
        <h4>The Nail Extension Process?</h4>
        <p>
          When you visit SCENT Salon for a nail extension in Bangalore, you can
          expect a meticulous process that ensures perfect results every time.
          Here’s a glimpse of what the procedure involves:
        </p>
        <ul>
          <li>
