  ...
  return (
    <div className="nailExtensionHead">
      <InnerNavi
        link="/nails-salon"
        service="Nails Salon"
        currService="Candle Spa Manicure"
      />
      ...
      <div className="nailExtensionHeading">
        ...
        <p>
          ...
          rejuvenation with our exquisite{" "}
      ...
      <div className="nailExtensionHeading">
        ...
        <p>
          ...
          is more than just a manicure; it is an indulgent, sensory journey that
          combines the soothing elements of candle wax and aromatic essential
          oils with the meticulous care of a traditional manicure. This
          treatment is designed to nourish your skin, strengthen your nails, and
          leave your hands feeling silky smooth and rejuvenated.
        </p>
      </div>
    </div>
  );
