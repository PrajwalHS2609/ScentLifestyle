    ...
    <div className="nailReadContainer">
      ...
      <div ref={switchRef} className="nailReadDisplayContainer">
        <ul>
          <li>
            <p>
              <span>Gel Polish: </span>Enjoy a long-lasting, glossy finish with
              our{" "}
              <a href="https://scentlifestyle.com/nails-salon">
                gel polish services
              </a>
          ...
          <li>
            <p>
              ...
              high-quality materials to create durable and beautiful nails that
              stand out.
            </p>
          </li>
          <li>
            <p>
              ...
              art designed by our talented artists. Whether you prefer intricate
              designs or minimalist patterns, our{" "}
              <a href="https://scentlifestyle.com/nails-salon">
          ...
          <li>
            <p>
              <span>Cat Eye Gel Polish:</span> Create a mesmerizing effect with
              our{" "}
              <a href="https://scentlifestyle.com/nails-salon">
                cat eye gel polish
              </a>
          ...
          <li>
            <p>
              ...
              . Perfect for special occasions or everyday wear, this polish adds
              a layer of glitter and shine that catches the eye.
            </p>
          </li>
          <li>
            <h3>Why Choose SCENT Salon?</h3>
            <p>
              As the <a href=""> best nails salon in Bangalore </a>, SCENT Salon
              is committed to providing an exceptional experience for our
              clients. Here are some reasons why our salon is the preferred
              choice for nail care:
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <span> High-Quality Products: </span> At SCENT Salon, we use only
              the finest products to ensure the health and beauty of your nails.
              From premium polishes to top-of-the-line tools, we prioritize
              quality in every aspect of our services.
            </p>
          </li>
          <li>
            <p>
              <span>Personalized Service: </span> We understand that each client
              has unique preferences and needs. Our personalized approach
              ensures that your nail treatment is customized to your liking,
              resulting in a look that reflects your individual style.
            </p>
          </li>
          <li>
            <p>
              <span>Relaxing Atmosphere: </span> Our salon provides a serene and
              welcoming environment where you can unwind and enjoy your{" "}
              <a href="https://scentlifestyle.com/nails-salon">nail treatment</a>. We aim to make every visit a
              relaxing and enjoyable experience.
            </p>
          </li>
          <li>
            <p>
              <span>Hygiene and Safety: </span> We adhere to strict hygiene and
              safety standards to protect our clients. All tools and equipment
              are thoroughly sanitized, and our technicians follow best
          ...
          <li>
            ...
            <p>
              Whether you’re looking for a simple <a href="https://scentlifestyle.com/nails-salon">manicure</a> or an{" "}
              <a href="https://scentlifestyle.com/nails-salon">elaborate nail design</a>, SCENT Salon is the ultimate
              destination for nail care in Bangalore. Here are some of the ways
              our services can elevate your nail game:
            </p>
          </li>
          <li>
            <p>
              <span>Flawless Manicures: </span>Our meticulous approach ensures
              that your manicure is perfect every time. From shaping and filing
              to cuticle care and polish application, we pay attention to every
              detail to achieve a flawless finish.
            </p>
          </li>
          <li>
            <p>
              <span>Stunning Pedicures: </span>Treat your feet to a{" "}
              <a href="https://scentlifestyle.com/nails-salon">luxurious pedicure at SCENT Salon</a>. Our pedicure
              services not only enhance the appearance of your nails but also
              promote foot health and relaxation.
            </p>
          </li>
          <li>
            <p>
              ...
              specific design in mind or need inspiration, we can create a look
          ...
          <li>
            <p>
              <span>Trendy Techniques:</span> Stay ahead of the trends with our
              innovative techniques such as chrome polish, ombre nails, and cat
              eye gel polish. These unique finishes add a modern and stylish
              touch to your nails.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              ...
              <a href="https://scentlifestyle.com/nails-salon">best nails salon in Bangalore?</a> Book your
              appointment at SCENT Salon today and discover the difference that
              expert care and high-quality service can make. Whether you’re
              looking for a simple polish change or a complete nail
              transformation, we’re here to help you achieve the look you
              desire. Visit us and elevate your appearance with our exclusive
              selection of high-end nail treatments.
            </p>
            <p>
              In conclusion, <a href="https://scentlifestyle.com/">SCENT Salon in Bangalore</a> is your go-to destination
              for luxurious nail care. With a wide range of services, expert
              technicians, and a commitment to quality, we guarantee an
              exceptional experience that will leave your nails looking their
              best. Join our satisfied clients and elevate your nail game at the
              <a href="https://scentlifestyle.com/nails-salon"> best nails salon in Bangalore</a>-SCENT Salon.
            </p>
          </li>
        </ul>
      </div>
