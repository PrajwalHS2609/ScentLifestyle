...
const NailExtensionBangaloreAfford = () => {
  return (
    <div className="nailSalonBookContainer">
    <h5>Affordable Nail Extensions in Bangalore: Quality at Competitive Prices</h5>
    <p>
...
export default NailExtensionBangaloreAfford
