...
import NailServiceCard from "./NailServiceCard";
const NailServiceCardContain = () => {
  return (
    <div className="nailCardContainer">
      <NailServiceCard
        heading="Nail Extensions"
        para="Refine and sculpt your nails with our meticulously crafted extensions, expertly designed to enhance the beauty of your nails using professional techniques and precision."
        goto="Nail Extensions"
        img="https://img.freepik.com/free-photo/woman-using-digital-nail-file_23-2148766613.jpg?t=st=1714634029~exp=1714637629~hmac=17de968d9d51b35eded6820b4eb257a439eebaf67afb7172e23cfd322166864b&w=900"
      />
      <NailServiceCard
      ...
      <NailServiceCard
        ...
        para="Experience the ultimate pampering with our Organic Manicure. Using natural and organic products, our skilled technicians will nourish and hydrate your nails and cuticles, leaving them healthy and beautiful."
      ...
      <NailServiceCard
        ...
        para="Treat your feet to the care they deserve with our Classic Pedicure. Sit back, relax, and enjoy a soothing foot soak, followed by nail shaping, cuticle care, and a moisturizing massage. Walk out feeling refreshed and rejuvenated."
      ...
      <NailServiceCard
        ...
        para="Indulge in our Organic Pedicure, featuring natural products to revitalize your feet. Enjoy a foot soak, gentle exfoliation, nail shaping, and cuticle care with organic ingredients. Leave feeling refreshed and pampered."
      ...
      <NailServiceCard
        ...
        para="Try our Candle Spa Manicure for luxury and expert nail care. Enjoy a warm wax treatment, nail shaping, cuticle care, and a hydrating massage for soft, tranquil hands."
      ...
      <NailServiceCard
        ...
        para="
        Elevate your elegance with our French Geleration service. Our skilled technicians apply durable gel polish for sophisticated nails that last weeks."
      ...
      <NailServiceCard
        ...
        para="
        Refresh your nail extensions with our Infill service. Our experts fill gaps, reshape, and maintain your nails' natural appearance, ensuring lasting flawlessness."
...
export default NailServiceCardContain;
