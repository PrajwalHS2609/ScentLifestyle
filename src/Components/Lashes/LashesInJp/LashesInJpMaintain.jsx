...
const LashesInJpMaintain = () => {
  return (
    <div className="HairSalonJpWhy">
      <h5>How to Maintain Your Eye Lashes in JP Nagar</h5>
      <p>
        To get the most out of your Eye Lashes in JP Nagar treatment, follow
      ...
      <ul>
        ...
        <li>
          <span>
            <img src={point} alt="checked" /> Use Oil-Free Products:
          </span>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            eye area to preserve the integrity of your Eye Lashes in JP Nagar
            treatment.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            determine the best schedule to keep your Eye Lashes in JP Nagar
            looking flawless.can help reduce stress levels and improve your
            overall well-being.
          </p>
        </li>
      </ul>
...
export default LashesInJpMaintain;
