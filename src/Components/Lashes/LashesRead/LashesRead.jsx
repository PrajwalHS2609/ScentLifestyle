      ...
      <div ref={switchRef} className="lashesReadDisplayContainer">
        <ul>
          ...
          <li>
            <ul>
              <h3>
                At SCENT Salon, we offer a variety of eyelash extension options
                to suit different preferences and styles. Our sets include:
              </h3>
              <li>
                <span>60 Lashes Set:</span> Ideal for a subtle enhancement, this
                set adds volume and length without being overly dramatic.
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                lashes offer a fuller, more dramatic appearance. They hold their
                curl well and are a great choice for those looking to add
                significant volume to their lashes.
              </li>
              <li>
                <span> Synthetic Lashes:</span> Made from man-made materials,
                synthetic lashes are durable and offer a bold, glamorous look.
                They are available in various lengths and thicknesses, allowing
                for a highly customizable appearance.
              </li>
              <li>
                ...
                multi-dimensional look that is both striking and sophisticated.
              </li>
            </ul>
          </li>
          <li>
            ...
            <p>
              ...
              , ensuring that your natural lashes remain healthy and undamaged.
              Here’s why you can trust us with your eyelash extensions:
            </p>
          </li>
          <li>
            <p>
              <span>Expert Technicians: </span> Our team has undergone extensive
              training in the latest techniques and safety protocols. They are
              skilled in creating beautiful, long-lasting results while
              prioritizing the health of your natural lashes.
            </p>
          </li>
          <li>
            <p>
              <span>High-Quality Products: </span> We use only the best
              materials and adhesives that are gentle on your natural lashes and
              skin. Our products are designed to provide secure adhesion and
              long-lasting wear without causing irritation.
            </p>
          </li>
          <li>
            <p>
              <span>Customized Approach: </span> We understand that each client
              is unique, which is why we offer personalized consultations and
              tailored treatments. Your extensions will be customized to suit
              your eye shape, lash length, and desired look.
            </p>
          </li>
          <li>
            <p>
              ...
              effectively. Attempting to remove extensions at home can result in
              damage to your natural lashes. Our technicians use gentle,
          ...
          <li>
            ...
            <p>
              At SCENT Salon, we strive to make our high-end services accessible
              to everyone. We regularly feature exclusive offers and promotions
              on our eyelash extension services, allowing you to experience
            ...
            <p>
              Eyelash extensions are more than just a beauty treatment—they are
              a way to enhance your natural allure and boost your confidence. At
              SCENT Salon, we offer an array of{" "}
              <a href="https://scentlifestyle.com/eye-lashes">
                eyelash extension
              </a>{" "}
            ...
            <p>
              ...
              across the city, expert application, and personalized service, we
              are committed to helping you achieve the lashes of your dreams.{" "}
