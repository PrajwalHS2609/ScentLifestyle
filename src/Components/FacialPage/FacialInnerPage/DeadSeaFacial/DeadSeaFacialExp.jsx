  ...
  return (
    <div className="bridalMakeUpPackageWhy">
      ...
      <p>
        ...
        apart? Here are some key differentiators:
      </p>
      <ul>
        <li>
          <span>
          ...
          <p>
            Our estheticians are highly trained and experienced in delivering
            <a href="https://scentlifestyle.com/facial"> top-notch skincare treatments</a>. They are passionate
            about helping you achieve your best skin ever.
          </p>
        </li>
...
export default DeadSeaFacialExp;
