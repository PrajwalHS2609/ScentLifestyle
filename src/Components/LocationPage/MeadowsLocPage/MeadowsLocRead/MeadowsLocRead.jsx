...
import "./MeadowsLocRead.css"
const MeadowsLocRead = () => {
  ...
  return (
    <div className="meadowsLocReadContainer">
    <div className="meadowsLocReadHeadContainer">
      <button>
    ...
    <div ref={switchRef} className="meadowsLocReadDisplayContainer">
      <ul>
        <li>
        ...
        <li>
          Our salon offers a comprehensive range of services, including
          haircuts, styling, coloring, facials, massages, manicures,
          pedicures, and more. Whether you're looking for a quick touch-up or
          a full day of relaxation, we have everything you need to look and
          feel your best.
        </li>
        <li>
        ...
        <li>
          In addition to our regular services, we also offer membership
          options for our loyal clients. Our membership program allows you to
