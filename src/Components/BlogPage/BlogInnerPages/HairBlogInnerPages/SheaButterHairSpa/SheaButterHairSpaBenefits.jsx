...
const SheaButterHairSpaBenefits = () => {
  return (
    <div className="blogBenefits-content">
      ...
      <li>
        <h6> Strengthens Hair and Reduces Breakage</h6>
        <p>
      ...
      <li>
        <h6> Tames Frizz and Enhances Shine</h6>
        <p>
      ...
      <li>
        <h6> Soothes Dry and Itchy Scalp</h6>
        <p>
      ...
      <li>
        <h6> Protects Against Heat and Environmental Damage </h6>
        <p>
