...
import softCaramelImg from "./../../../../Images/Blog/Top 10 hairColor/Soft Caramel Highlights.png";
  ...
  return (
    <div className="blogHead-content">
      ...
      <p>
        ...
        adding a sun-kissed glow to your hair, making it ideal for the warmer
        months.
      </p>
    </div>
  );
