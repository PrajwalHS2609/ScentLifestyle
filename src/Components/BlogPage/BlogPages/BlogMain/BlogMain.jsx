...
const BlogMain = () => {
  ...
  //   if (!toggle) {
  //     setToggle(true);
  //     switchRef1.current.style.display = "flex";
  //   } else {
  //     setToggle(false);
  //     switchRef1.current.style.display = "none";
  //   }
  // };
  const responsive = {
    superLargeDesktop: {
    ...
    <div className="blogMainContainer">
      ...
      >
        <div>
          ...
          <div className="blogMainDisplay2" ref={switchRef1}>
            <BlogCard
              img={hairKeratin}
        ...
        <div>
          ...
          <div className="blogMainDisplay2" ref={switchRef2}>
            <BlogCard
              img={curlyHairBanner}
